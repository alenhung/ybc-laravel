    ...
    <div class="container">
      <div class="columns">
        ...
        <div class="column content is-6 is-offset-1 m-r-20 m-l-20">
          ...
          <br>
          <br>
          <a class="button is-ybc-brown-btn m-b-20">了解我們的經營理念</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="columns">
        ...
        <div class="column content is-6 is-offset-1 m-r-20 m-l-20">
          ...
          <br>
          <br>
          <a class="button is-ybc-brown-btn m-b-20">了解我們的未來願景</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="columns">
        ...
        <p>邁向全面科技化的21世紀，員邦企業始終堅持理念，為開創更美好的前景持續努力著，繼續兼持:誠信的服務、專業的配合、合理的價位之原則，希望有機會能為更多的企業做最好的服務。</p>
          <br>
          <br>
          <a class="button is-ybc-brown-btn m-b-20">了解我們的關係企業</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="columns">
        ...
        <div class="column content is-6 is-offset-1 m-r-20 m-l-20">
          ...
          <br>
          <br>
          <a class="button is-ybc-brown-btn m-b-20">返回公司簡介</a>
        </div>
      </div>
    </div>
  </section>
