            ...
            <tbody>
              @foreach ($workings as $working)
                <tr>
                  ...
                  <td class="has-text-right"><a class="button is-outlined m-r-5" href="{{route('workings.show', $working->id)}}"><i class="fa fa-eye m-r-10" aria-hidden="true"></i>檢視</a><a class="button is-light is-info" href="{{route('workings.edit', $working->id)}}"><i class="fa fa-pencil m-r-10" aria-hidden="true"></i>編輯</a></td>
                </tr>
              @endforeach
            </tbody>
          </table>
