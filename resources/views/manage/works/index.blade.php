            ...
            <tbody>
              @foreach ($works as $work)
                <tr>
                  ...
                  <td class="has-text-right"><a class="button is-outlined m-r-5" href="{{route('works.show', $work->id)}}">檢視</a><a class="button is-light" href="{{route('works.edit', $work->id)}}">編輯</a></td>
                </tr>
              @endforeach
            </tbody>
          </table>
